...
import com.ecommerce.ecommerce_authentication_service.response.ErrorResponse;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<Object> handleAuthenticationServiceExceptions(AuthenticationServiceException ex) {
